...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'fongsera@1ove.eu.org',
  ...
  protectedRoutes: ['/YELL'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:i@121318.xyz',
  ...
  links: [
    {
      name: '导航',
      link: 'https://g.121318.xyz',
    },
    {
      name: '博客',
      link: 'https://eqing.121318.xyz',
    },
  ],
